...
export function printOrderReceipt(order:PrintableOrder,opts:ReceiptOptions){
  ...
  const mobilePageCss=isMobileOrTablet?`@page{size:auto;margin:6mm}body{width:${width};zoom:${printScale};margin:0;padding:2.5mm}`:`@page{size:${width} auto;margin:0}html,body{width:${width};margin:0 auto!important}body{padding:3mm;overflow:hidden}`;
