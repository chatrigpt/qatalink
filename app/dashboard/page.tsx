...
export default function Dashboard(){
  ...
  return <div className="dashboard-shell">
    ...
    <main className="dash-main">
      ...
      {!hasPlan&&ready&&paymentState!=='pending'&&<div className="free-banner"><div><b>Votre dashboard est prêt.</b><span>Explorez Qatalink gratuitement. Vous choisirez votre formule uniquement au moment de créer votre premier menu ou catalogue.</span></div><button className="btn btn-primary" onClick={()=>setGate(true)}>Voir les offres</button></div>}
