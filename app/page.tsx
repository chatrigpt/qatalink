...
const faqItems=[
  ...
  ['Que puis-je tester pendant les 7 jours gratuits ?','Pendant 7 jours, vous pouvez tester la création, la personnalisation, le panier, les QR, les illustrations, les thèmes, les dispositions et la publication.'],
  ['Comment payer mon abonnement Qatalink ?','Les abonnements mensuels et annuels se règlent par Mobile Money depuis la page de paiement sécurisée. Les recharges de crédits utilisent également le Mobile Money.'],
  ...
  <main>
    <section className="hero container hero-conversion">
      <div className="hero-conversion-copy">
        ...
        <div className="hero-reassurance"><span><Check size={13}/>L’essai commence au premier catalogue</span><span><Check size={13}/>QR permanent</span><span><Check size={13}/>WhatsApp intégré</span></div>
      </div>
      <HeroActivationDemo/>
    </section>
    ...
    <section className="section alt" id="pricing"><div className="container"><div className="section-head"><div className="eyebrow">Tarifs simples</div><h2>7 jours pour créer, publier et obtenir vos premières interactions.</h2><p>Aucune carte au départ. L’essai commence à la création de votre premier catalogue. Une illustration coûte 5 crédits.</p></div><div className="mobile-money-pricing-note"><Smartphone size={21}/><div><b>Paiement par Mobile Money</b><span>Quand vous choisissez une formule, le règlement se fait par Mobile Money sur la page de paiement sécurisée.</span></div></div><div className="pricing">
      ...
      <Price name="Interactif" price="5 000" annual="55 000" oldAnnual="60 000" featured features={['Tout Basic','Sélection de plusieurs articles','Panier détaillé','Commande WhatsApp contextualisée','150 crédits image inclus','Studio avancé']} />
      <Price name="Vitrine" price="7 500" annual="82 500" oldAnnual="90 000" features={['Tout Interactif','Page Vitrine personnalisée','Réseaux sociaux et liens externes','Lien Google Maps','250 crédits image inclus','Menu/catalogue en bouton principal']} />
    </div><p style={{textAlign:'center',marginTop:18,color:'var(--muted)'}}>Besoin de plus d’illustrations ? Pack de 100 crédits à 2 000 F CFA pour les abonnés, payable par Mobile Money.</p></div></section>
