...
import { PublicCurrencyLocalizer } from '@/components/public-currency-localizer';
...
export default async function PublicCatalogPage({params}:{params:Promise<{slug:string}>}){
  ...
  return <><PublicCatalogV2 data={data}/><PublicCurrencyLocalizer baseCurrency={data?.business?.currency_code||'XOF'}/><PublicAnalyticsTracker/><PublicFlowCustomizer settings={data?.business?.customer_flow_settings||{}}/></>;
}
