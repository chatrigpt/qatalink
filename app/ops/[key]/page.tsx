...
export default async function OpsPage({params}:{params:Promise<{key:string}>}){
  ...
  return <><TeamOrderConsole accessKey={key}/><OpsOrderNotifications accessKey={key}/><OpsHubManager accessKey={key}/><OpsPosStats accessKey={key}/><OpsCatalogOrderControls accessKey={key}/></>;
}
