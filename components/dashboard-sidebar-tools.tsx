...
import {Headphones,Link2,Palette,Route,ShieldCheck} from 'lucide-react';
...
export function DashboardSidebarTools(){
  ...
  const tools=<>
    ...
    <button className="dash-tool-nav" onClick={()=>window.dispatchEvent(new CustomEvent('qatalink:support-open'))}><Headphones size={16}/><span>Support</span></button>
