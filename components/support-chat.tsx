...
import {Bell, BellOff, MessagesSquare,Send,X} from 'lucide-react';
...
export function SupportChat(){
  ...
  useEffect(()=>{const handler=()=>{setOpen(true);setUnread(0)};window.addEventListener('qatalink:support-open',handler);if(new URLSearchParams(window.location.search).get('support')==='1')setOpen(true);return()=>window.removeEventListener('qatalink:support-open',handler)},[]);
