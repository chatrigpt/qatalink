...
import {ExternalLink,Facebook,Globe2,ImagePlus,Instagram,Link2,MapPin,MessageCircle,Music2,Plus,Save,Sparkles,Trash2,X,Youtube} from 'lucide-react';
import {createSupabaseBrowserClient} from '@/lib/supabase';

type Business={id:string;name:string;slug:string;description:string|null;profile_headline:string|null;profile_bio:string|null;linkhub_enabled:boolean;whatsapp_number:string|null};
