...
function enhancePricing(){
  ...
  add('forecast','<span>✓</span><span><b>Prévisions & réapprovisionnement</b> <em>BETA</em><small>Anticipez demande, ruptures, surplus, pertes et gaspillage · 15 crédits IA par calcul.</small></span>');
