...
function enhancePricing(){
  ...
  add('forecast','<span>✓</span><span><b>Prévisions & réapprovisionnement</b> <em>BETA</em><small>Ventes, saisonnalité, météo, promos et stock.</small></span>');
